...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SmartScore AI predicts student performance, tracks progress, and helps teachers identify weak students at University." },
      { name: "author", content: "COMSATS University" },
      { property: "og:title", content: "SmartScore AI — Student Performance Prediction" },
      { property: "og:description", content: "SmartScore AI predicts student performance, tracks progress, and helps teachers identify weak students at University." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "SmartScore AI — Student Performance Prediction" },
      { name: "twitter:description", content: "SmartScore AI predicts student performance, tracks progress, and helps teachers identify weak students at University." },
